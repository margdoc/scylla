...
extern const std::string_view maintenance_mode_role_manager_name;

class maintenance_mode_role_manager final : public role_manager {
public:
    maintenance_mode_role_manager(cql3::query_processor&, ::service::migration_manager&) {}
