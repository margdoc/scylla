...
// static
// bytes get_new_value(const cql3::statements::modification_statement& statement) {
...
// static
// std::optional<bytes_opt> get_value_condition(const cql3::statements::modification_statement& statement) {
...
// future<> execute(service::raft_group0_client& group0_client, const cql3::cql_statement& statement) {
//     compile(statement);
