...
async def test_broken_bootstrap(manager: ManagerClient):
    ...
    await manager.server_update_config(server_a.server_id, "error_injections_at_startup", ["topology_coordinator_wait_for_start", "write_both_read_old_wait_to_apply"])
